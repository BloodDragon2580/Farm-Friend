...
L["FARM_Friend_COMMAND_RESET_DESC"] = "Resets Farm Friend to it's default settings."
L["FARM_Friend_COMMAND_SETTINGS_DESC"] = "Open up the AddOn settings page."
L["FARM_Friend_COMMAND_TRACK_ARGS"] = "Item ID | Item Name | Item Link"
L["FARM_Friend_COMMAND_TRACK_DESC"] = "Sets the tracked item."
L["FARM_Friend_COMMAND_VERSION_DESC"] = "Show the current used Farm Friend Version."
...
L["FARM_Friend_ENGLISH"] = "English"
L["FARM_Friend_RUSSIAN"] = "Russian"
...
L["FARM_Friend_TRACKING_DESC"] = "You can track up to 12 items at once and select one item that is shown in the titan bar the other items are shown in the tooltip of Farm Friend."
